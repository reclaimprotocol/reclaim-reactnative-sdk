...
export class ProofNotReceivedError extends Error {
  constructor(message?: string) {
    super(message);
    this.name = 'ProofNotReceivedError';
  }
}
...
export class ProofCallbackError extends Error {
  constructor(message?: string) {
    super(message);
    this.name = 'ProofCallbackError';
  }
}
